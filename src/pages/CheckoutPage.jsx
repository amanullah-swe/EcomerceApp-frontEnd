...
const addresses = [
    {
        ...
        pinCode: '431112',
        phone: '9767837923',
        street: 'New York main street'

    },
    {
        name: 'Alen cazendro',
        email: 'Alen.cazendro@example.com',
        city: 'London',
        pinCode: '431112',
        phone: '9385032938',
        street: 'newton school'
                                ...
                                <div className="mt-10 space-y-10">
                                    <ul className="divide-y divide-gray-100 my-2">
                                        {addresses.map((address,) => (
                                            <li key={address.email} className={`flex justify-between py-5 border-gray-300 border-1 px-2 mb-2`}>
                                                <div className="flex gap-x-4">
                                                    ...
                                                    <div className="min-w-0 flex-auto">
                                                        ...
                                                        <p className="truncate text-xs leading-5 text-gray-500">{address.street}</p>
                                                    ...
                                                    <div className="flex flex-1 items-end justify-between text-sm">
                                                        <p className="text-gray-500">Qty
                                                            <select name="" id="" className='p-1'>
                                                                <option value="" className='p-2'>1</option>
                                                                <option value="" className='p-2'>2</option>
                                                                <option value="" className='p-2'>3</option>
                                                                <option value="" className='p-2'>4</option>
                                                                <option value="" className='p-2'>5</option>
                                                            </select></p>
                                                        <div className="flex">
                                                            <button
                                                                type="button"
